...
public class FaceAntiSpoofing {
    ...
    public static final int INPUT_IMAGE_SIZE = 256; // The image width and height of the placeholder that requires feed data
    public static final float THRESHOLD = 0.8f; // Set a threshold value. A value greater than this value is considered an attack.

    public static final int ROUTE_INDEX = 6; // Route index observed during training

    public static final int LAPLACE_THRESHOLD = 50; // Laplacian sampling threshold
    public static final int LAPLACIAN_THRESHOLD = 500; // Image clarity judgment threshold图片清晰度判断阙值
