...
@property (nonatomic, copy) void (^PunchInresultHandler)(NSDictionary *resultData);
@property (nonatomic, copy) void (^PunchOutresultHandler)(NSDictionary *resultData);
@property (nonatomic, copy) void (^ForgotPunchOutresultHandler)(NSDictionary *resultData);
